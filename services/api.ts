...
const MOCK_COURSES = [
  { 
    ...
    Lessons: [
      ...
      { id: 102, title: "Final Project", type: "assignment", AssignmentSubmissions: [] }
    ] 
  }
];

const MOCK_USERS = [
  { id: 1, name: "Demo Student", email: "student@openclass.com", role: "student", is_verified: true, is_active: true, createdAt: "2023-10-01" },
  { id: 2, name: "Demo Teacher", email: "teacher@openclass.com", role: "teacher", is_verified: true, is_active: true, createdAt: "2023-09-15" }
];
